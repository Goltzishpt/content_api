...
app.add_url_rule('/post/<int:post_id>', view_func=post.show_post, methods=['GET'])
app.add_url_rule('/post/<int:post_id>', view_func=post.update_post, methods=['PUT'])
app.add_url_rule('/post/<int:post_id>', view_func=post.delete_post, methods=['DELETE'])
